...
(function() {
  ...
  const formatDirectionxx = function(dir, opt_angle) {
    if (opt_angle == '+/-180°')
      return avnav.api.formatter.formatDecimal(to180(dir));
    else
      return avnav.api.formatter.formatDecimal(to360(dir));
  };

  formatDirectionxx.parameters = [{
    name: 'opt_angle',
    type: 'SELECT',
    list: ['+/-180°', '360°'],
    default: '360°'
  ...
  avnav.api.registerFormatter("formatDirectionxx", formatDirectionxx);
  ...
  */
  ...
  var SailInstrumentHistoryWidget = {
    ...
    aspect: 3,
    quantity: "TWD",
    //		formatter: avnav.api.formatter.formatDecimal,
    storeKeys: {
      TIME: 'nav.gps.rtime',
  ...
  var SailInstrumentHistoryWidgetParams = {
    ...
    {
      type: 'SELECT',
      list: ['formatDecimal', 'formatDirectionxx', 'formatDirection', 'formatSpeed', 'formatDistance'],
