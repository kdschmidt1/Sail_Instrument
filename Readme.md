...
VMG (Velocity made good against wind) is defined as VMG = Boatspeed * COS(TWA), so meaning the course the for the fastest course to a waypoint directly in wind direction.
VMC (Velocity made good on course) is defined as VMC = Boatspeed * COS(BRG-HDG); meaning the course for the fastest course to your waypoint.
...
I have attached examples for all three strategies in the following:
